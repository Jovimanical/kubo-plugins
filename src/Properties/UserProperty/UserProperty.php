...
class UserProperty
{
    ...
    public static function viewPropertyChildren(int $propertyId, array $floorData = [])
    {
        ...
        if ($propertyType == "block") {
            ...
            foreach ($results as $key => $result) {
                ...
                $parentQueries[] = "SELECT a.MetadataId, a.FieldName, a.FieldValue, a.PropertyId FROM Properties.UserPropertyMetadataBlocks a INNER JOIN Properties.UserPropertyBlocks b ON a.PropertyId = b.PropertyId WHERE a.PropertyId = $resultPropertyId AND b.PropertyFloor = $resultPropertyFloor";
    ...
    public static function deleteOldUploadData(int $userId, array $data)
    {
        ...
        $resultPropertyId = $resultSelect[0]["PropertyId"];
        $resultLinkedEntity = $resultSelect[0]["LinkedEntity"];
